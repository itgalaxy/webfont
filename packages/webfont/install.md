...
[`grunt-webfont`](https://github.com/sapegin/grunt-webfont) is archived. Use a custom Grunt task that calls `webfont()` and `writeResultFiles()` — see [Grunt integration](./docs/grunt.md) ([#771](https://github.com/itgalaxy/webfont/issues/771), [ADR 0014](../../docs/adr/0014-no-grunt-webfont-recipe-workspace.md)).
...
- **Grunt:** see [Grunt integration](./docs/grunt.md) (replacement for archived `grunt-webfont`).
